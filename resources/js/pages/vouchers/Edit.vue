      ...
      <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          ...
          <p class="text-gray-600">
            Update financial voucher details
          </p>
        </div>
          ...
          <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-200">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">
                Update the financial details of the voucher
              </p>
            </div>
          </div>
...
const fetchVoucherData = async () => {
  try {
    ...
    showErrorAlert('Error', 'Failed to load voucher data')
...
const submitForm = async () => {
  ...
  try {
    showLoadingAlert('Updating voucher...')
    ...
    if (error.response?.status === 422) {
      ...
      showErrorAlert('Error', 'Failed to update voucher. Please try again.')
    }
  }
}
