          ...
          <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-200">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">
                Fill in the details of outgoing cash transaction
              </p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Outgoing transaction overview</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <ul class="text-sm text-red-700 space-y-1">
                ...
                <li>• Voucher type is automatically DEBIT</li>
                <li>• Select the source account</li>
                <li>• Account balance will decrease</li>
...
const submitForm = async () => {
  ...
  try {
    showLoadingAlert('Recording cash out transaction...')
    ...
    if (error.response?.status === 422) {
      ...
      console.error('Error creating cash out voucher:', error)
      showErrorAlert('Error', 'Failed to record cash out transaction. Please try again.')
    }
  }
}
