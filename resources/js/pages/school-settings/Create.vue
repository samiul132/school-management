        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Basic school details</p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Upload school logo</p>
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <!-- Logo Preview -->
            <div v-if="form.logoPreview" class="mt-4">
              ...
              <div class="flex items-center gap-4">
                <div class="w-32 h-32 rounded-lg overflow-hidden border-4 border-white shadow-lg">
                  <img :src="form.logoPreview" alt="Logo Preview" class="w-full h-full object-cover">
                </div>
                <div class="text-sm text-gray-600">
                  <p class="font-medium mb-1">Preview Details:</p>
                  <p>• Size: {{ logoFileSize }}</p>
                  <p>• Dimensions: {{ logoDimensions }}</p>
                  <p>• Format: {{ logoFormat }}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 class="text-xl font-semibold text-gray-800">Save Settings</h3>
              <p class="text-gray-600 text-sm">Complete and save settings</p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Preview your settings</p>
            </div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="flex justify-center">
              ...
              >
                <img :src="form.logoPreview" alt="School Logo" class="w-full h-full object-cover">
              </div>
              <div 
                v-else 
        ...
        <div class="bg-blue-50 rounded-2xl border border-blue-200 p-6">
          ...
          <ul class="space-y-2 text-blue-700 text-sm">
            <li class="flex items-start gap-2">
              ...
              <span>School name is required for identification</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
              <span>Upload a clear, professional school logo</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
            ...
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
              <span>You can update these settings later</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
...
const submitForm = async () => {
  ...
  try {
    ...
    showLoadingAlert('Creating school settings...')
    ...
    // IMPORTANT: POST request to /api/school-settings
    const response = await axios.post('/api/school-settings', formData, {
      headers: {
    ...
    if (response.data) {
      showSuccessAlert('Success!', 'School settings created successfully.')
      router.push({ 
        name: 'school-settings.index',
        query: { created: 'true' }
      })
    } else {
      showErrorAlert('Error', 'Failed to create school settings')
    }
    ...
    if (error.response && error.response.status === 422) {
      ...
      const errorMessage = error.response.data.message || 
                          ...
                          'Failed to create school settings. Please try again.'
      showErrorAlert('Error', errorMessage)
    } else if (error.request) {
      // Network error
      showErrorAlert('Network Error', 'No response from server. Please check your connection.')
    } else {
      showErrorAlert('Error', 'Failed to create school settings. Please try again.')
    }
  }
}
