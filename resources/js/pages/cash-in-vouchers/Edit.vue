      ...
      <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          <h1 class="text-3xl font-bold text-gray-800">
            Edit Cash In Voucher
          </h1>
          <p class="text-gray-600">
            Update incoming cash transaction details
          </p>
        </div>
        <div class="flex items-center gap-3 mb-2">
          <router-link 
            :to="{ name: 'cash-in-vouchers.index' }"
            class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow transition-colors font-semibold"
          >
          ...
          <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-200">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">
                Update the details of incoming cash transaction
              </p>
            </div>
          </div>
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    id="date"
                    v-model="form.date"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white text-gray-800"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white text-gray-800 placeholder-gray-500"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white text-gray-800 placeholder-gray-500 resize-y"
          ...
          <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex flex-col sm:flex-row justify-end gap-3">
              ...
              >
                ...
                {{ loading ? 'Updating...' : 'Update Cash In' }}
              </button>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <ul class="text-sm text-green-700 space-y-1">
                ...
                <li>• Voucher type is fixed as CREDIT</li>
...
const fetchVoucherData = async () => {
  try {
    ...
    // Ensure voucher is CREDIT type (cash in)
    if (voucherData.voucher_type !== 'CREDIT') {
      showErrorAlert('Error', 'This is not a cash in voucher')
      router.push({ name: 'cash-in-vouchers.index' })
      return
    }
    
    Object.assign(form, {
      date: voucherData.date ? voucherData.date.split('T')[0] : '',
      voucher_type: 'CREDIT', // Force CREDIT type
    ...
    showErrorAlert('Error', 'Failed to load cash in voucher data')
    router.push({ name: 'cash-in-vouchers.index' })
  }
}
...
const submitForm = async () => {
  ...
  try {
    showLoadingAlert('Updating cash in voucher...')
    ...
    if (error.response?.status === 422) {
      ...
      showErrorAlert('Error', 'Cash in voucher not found')
      router.push({ name: 'cash-in-vouchers.index' })
    } else {
      console.error('Error updating cash in voucher:', error)
      showErrorAlert('Error', 'Failed to update cash in voucher. Please try again.')
    }
  }
}
