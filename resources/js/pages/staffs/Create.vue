    ...
    <div class="mb-8">
      <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          ...
          <p class="text-gray-600 mt-2">Add a new staff member to the system</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Staff's basic details</p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Job details</p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Upload staff photo</p>
            </div>
          </div>

          <div class="space-y-4">
            <div class="space-y-2">
              <label class="block text-sm font-medium text-gray-700 mb-2">Staff Photo</label>
              <input 
                type="file" 
                ref="imageInput"
                class="dropify" 
      ...
      <div class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 text-sm">Set staff status</p>
            </div>
          </div>
        ...
        <div class="bg-blue-50 rounded-2xl border border-blue-200 p-6">
          ...
          <ul class="space-y-2 text-blue-700 text-sm">
            ...
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
              <span>Upload a clear staff photo for easy identification</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
              <span>Set correct salary and working hours</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fas fa-check-circle text-blue-500 mt-1"></i>
              <span>Set status to active to make staff visible</span>
            </li>
          </ul>
        </div>
      </div>
...
const submitForm = async () => {
  ...
  try {
    ...
    showLoadingAlert('Creating staff...')
    ...
    const response = await axios.post('/api/staffs', formData, {
    ...
    if (response.data.success) {
      ...
      showErrorAlert('Error', response.data.message || 'Failed to create staff')
    }
    ...
    if (error.response && error.response.status === 422) {
      ...
      showErrorAlert('Error', error.response.data.message || 'Failed to create staff. Please try again.')
    } else {
      showErrorAlert('Error', 'Failed to create staff. Please try again.')
    }
  }
}
